                            ...
                            <div class="flex flex-col sm:flex-row mt-10">
                                <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                                    ...
                                    <div class="flex flex-col items-center text-center justify-center">
                                        ...
                                        <p class="text-base ml-4 mr-4 text-gray-950 ">${element[index]['title']}.</p>
                                    </div>
                                </div>
                                <div
                                    class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                                    <p class="leading-relaxed text-gray-950 text-lg mb-4 break-normal mr-4 ml-2">${element[index]['body'].slice(0, 900)}.</p>
                                    <a class="text-red-400 inline-flex items-center ml-3" href="${element[index]['url']}" target="_blank">Learn More
                                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
